...
const Header = () => {
  return (
    <section className='fixed top-0 left-0 right-0 z-10 max-md:text-center'>
      <div className="bg-black py-4 md:py-3">
        <div className="container">
          <div className="flex flex-wrap items-center justify-between text-white [&_p]:mb-0">
            <div className="w-full md:w-1/2 font-semibold max-md:text-sm max-md:text-center max-md:mb-4">
            ...
            <div className="w-full md:w-1/2 flex items-center flex-wrap gap-y-4 justify-center md:justify-end">
      ...
      {/* /Top Header */}
      <header className='py-5 bg-gradient-to-l from-black from-5% via-transparent to-transparent top-90%'>
        <div className="container">
